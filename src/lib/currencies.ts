export const currencies = [
    ...
    { value: 'BAM', label: 'BAM - Convertible Mark', symbol: 'KM' },
    ...
    { value: 'BZD', label: 'BZD - Belize Dollar', symbol: '$' },
    ...
    { value: 'CVE', label: 'CVE - Cabo Verdean Escudo', symbol: 'Esc' },
    ...
    { value: 'GYD', label: 'GYD - Guyanese Dollar', symbol: '$' },
    ...
    { value: 'KGS', label: 'KGS - Kyrgyzstani Som', symbol: 'с' },
    ...
    { value: 'MMK', label: 'MMK - Burmese Kyat', symbol: 'Ks' },
    { value: 'MNT', label: 'MNT - Mongolian Tögrög', symbol: '₮' },
    ...
    { value: 'PYG', label: 'PYG - Paraguayan Guaraní', symbol: '₲' },
    ...
    { value: 'SLE', label: 'SLE - Sierra Leonean Leone', symbol: 'Le' },
    ...
    { value: 'TMT', label: 'TMT - Turkmenistan Manat', symbol: 'm' },
    ...
    { value: 'UZS', label: 'UZS - Uzbekistani Som', symbol: "so'm" },
    { value: 'VES', label: 'VES - Venezuelan Bolívar Soberano', symbol: 'Bs.' },
    { value: 'VND', label: 'VND - Vietnamese Đồng', symbol: '₫' },
    { value: 'VUV', label: 'VUV - Vanuatu Vatu', symbol: 'Vt' },
    { value: 'WST', label: 'WST - Samoan Tālā', symbol: 'T' },
    ...
    { value: 'ZWG', label: 'ZWG - Zimbabwe Gold', symbol: 'ZiG' },
];
